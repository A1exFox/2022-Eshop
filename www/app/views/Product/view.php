        ...
        <div class="col-md-4 order-md-2">
            ...
            <ul class="list-unstyled">
                ...
                <li>
                    ...
                    <span class="product-price">
                        <?php if (0 !== (int)$product['old_price']): ?>
            ...
            <div id="product">
                <div class="input-group mb-3">
                    ...
                    <button class="btn btn-danger add-to-cart" type="button" data-id="<?= $product['id'] ?>"><?= ___('product_view_buy') ?></button>
                </div>
            </div>
                ...
                <?php if (!empty($gallery)): ?>
                    <?php foreach ($gallery as $item): ?>
                        <li class="thumb-additional">
                            <a class="thumbnail" href="<?= $item['img'] ?>" data-effect="mfp-zoom-in">
